...
if (isset($_POST['id'])) {
    ...
    if ($foto_size > 2097152) {
       ...
       header("location:datanonpertanian.php?pesan=size");
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            if($query){
                ...
                header("location:formeditnonpertanian.php?pesan=gagal");
            }

        } else { 
            // Jika ekstensinya tidak sesuai dengan apa yg kita tetapkan maka error
            header("location:formeditnonpertanian.php?pesan=ekstensi");        }
