      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="nonpertanian1.php" class="btn btn-md btn-warning" style="margin-bottom: 10px">Tambah Data</a>
              ...
              <?php } ?>
                      ...
                      <td class="text-center">
                        <a href="formeditnonpertanian1.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-info">EDIT</a>
                        <a href="hapus-nonpertanian1.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
