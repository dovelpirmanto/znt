        ...
        <div class="col-md-8 offset-md-2">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="simpan-nonpertanian1.php" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" class="form-check-input" name="fasilitasrumah[]" value="Gas">Gas &nbsp  &nbsp  &nbsp
