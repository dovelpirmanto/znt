...
<html lang="en">
  <head>
    ...
    <title>Data Non Pertanian</title>
  </head>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <a href="nonpertanian.php" class="btn btn-md btn-warning" style="margin-bottom: 10px">Tambah Data</a>
              <a href="excelnonpertanian.php" class="btn btn-md btn-success" style="margin-bottom: 10px">Eksport Excel</a>
              ...
              <table class="table-responsive" id="myTable" border="1" bordercolor="gainsboro">
                ...
                <tbody>
                  <?php 
                      include('koneksi.php');
                      $no = 1;
                      $query = mysqli_query($mysqli,"SELECT * FROM nonpertanian");
              ...
              <?php } ?>
                      ...
                      <td class="text-center">
                        <a href="formeditnonpertanian.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-info">EDIT</a>
                        <a href="hapus-nonpertanian.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                        <a href="pdfnonpertanian.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">CETAK</a>
                      </td>
                  </tr>
