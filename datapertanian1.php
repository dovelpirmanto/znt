            ...
            <div class="card-body">
              ...
              <?php } ?>
                      ...
                      <td class="text-center">
                        <a href="formeditpertanian1.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-info">EDIT</a>
                        <a href="hapus-pertanian1.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                        <a href="pdf.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">CETAK</a>
                      </td>
                  </tr>
